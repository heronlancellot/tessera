...
export declare const Constants: {
    ...
    readonly public: {
        readonly Enums: {
            readonly publisher_status: readonly ["pending", "approved", "rejected"];
            readonly request_status: readonly ["pending", "completed", "failed"];
            readonly request_type: readonly ["preview", "fetch"];
        };
    };
};
export {};
